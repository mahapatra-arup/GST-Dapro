...
public static class HardwareInfo
{
    ...
    public static String GetHDDSerialNo()
    {
        ...
        foreach (ManagementObject wmi_HD in searcher.Get())
        {
            ...
            if (wmi_HD["SerialNumber"] != null)
                hddSlNo = wmi_HD["SerialNumber"].ToString().Trim();
        }
        return hddSlNo;
    }
    /// <summary>
    ...
    /// </summary>
    /// <returns></returns>
    public static string GetBaseBoardSlNo()
    {
        string baseBoardSlNo = "";
        ...
        try
        {
            foreach (ManagementObject share in searcher.Get())
            {
                ...
                {
                    if (PC.Name.Trim() == "SerialNumber")
                    {
                        if (PC.Value != null && PC.Value.ToString() != "")
                        {
                            baseBoardSlNo = PC.Value.ToString();
                        }
                        else
                        {
                            baseBoardSlNo = "No Information available";
                        }
                    }
                }
            }
